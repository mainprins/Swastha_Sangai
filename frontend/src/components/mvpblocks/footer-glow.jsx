...
export default function FooterGlow() {
    ...
    <footer className="relative z-10 mt-8 w-full overflow-hidden pt-16 pb-8">
      <style jsx global>{`
        .glass {
          ...
          background: radial-gradient(circle, #f0fff4 0%, #d1fae5 60%, #ecfdf5 100%);
  ...
  circle,
  oklch(0.72 0.19 150 / 0.12) 0%,   /* soft light center */
  oklch(0.72 0.19 150 / 0.08) 55%,  /* smoother mid fade */
  oklch(0.72 0.19 150 / 0.16) 100%  /* subtle darker edge */
) !important;
      ...
      <div className="pointer-events-none absolute top-0 left-1/2 z-0 h-full w-full -translate-x-1/2 select-none">
        ...
        <div className="absolute right-1/4 -bottom-24 h-80 w-80 rounded-full bg-priamry/20 blur-3xl"></div>
      </div>
      <div className="glass relative mx-auto flex w-[90%] flex-col items-center gap-8 rounded-2xl px-6 py-10 md:flex-row md:items-start md:justify-between md:gap-12">
        <div className="flex flex-col items-center md:items-start">
          <a href="#" className="mb-4 flex items-center gap-2">
            <span className="text-foreground text-3xl font-light font-space-grotesk">
              Swastha
            </span>
            <span className="bg-gradient-to-br font-space-grotesk from-primary/20 to-primary bg-clip-text text-3xl font-semibold tracking-tight text-transparent">
              Sangai
            </span>
          </a>
      ...
      <div className="text-foreground relative z-10 mt-10 text-center text-xs">
        <span>&copy; 2025 SwasthaSangai. All rights reserved.</span>
      </div>
    </footer>
  );
}